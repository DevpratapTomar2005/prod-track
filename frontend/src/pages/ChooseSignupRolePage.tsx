  ...
  return (
    <>
      <div className="mt-30 w-full">
        <div className="mt-10">
          <div>
            <h1 className="max-[350px]:text-4xl text-5xl  font-bold text-neutral-800 text-center w-[55%] mx-auto">
        ...
        <div className="w-full grid grid-cols-2 divide-x  h-full overflow-y-hidden max-[760px]:grid-cols-1">
          <div className=" border-gray-200 h-full max-[706px]:col-span-1 max-[760px]:border-b">
            <Card
              perks={IndividualPerks}
              img={UserSolo}
              title="Individual"
              subtitle="Maximize Your Own Productivity"
              buttonText="Browse Plans"
              btnLink="/auth/register/user"
            />
          </div>

          <div className="h-full max-[760px]:col-span-1">
            <Card
              perks={OrganizationPerks}
              img={UserGroup}
              title="Organizations"
              subtitle="Scale Team Efficiency & Collaboration"
              buttonText="Browse Plans"
              btnLink="/auth/register/org"
            />
          </div>
        </div>
      </div>
