...
const TaskPage = () => {
  ...
  >([
    {
      ...
      subtasks: [
        {
          id: 2278,
          subtask: "Work on frontend",
        },
        {
          id: 2279,
          subtask: "Work on backend",
        },
      ],
    },
  ]);
  ...
  const handleToggleViewTaskModal = (task) => {
  ...
  return (
    <div className={`grid grid-cols-3 bg-white`}>
      ...
      >
        ...
        >
          <Timer
            value={1}
            unit="minutes"
            label="#TASK-2989: Resolve login issue"
              ...
              <tbody className="text-[12px] text-gray-600 font-poppins">
                {tasks.map((task) => (
                  <tr
                    key={task.id}
                    className="hover:bg-gray-50 cursor-pointer"
                    onClick={() => handleToggleViewTaskModal()}
                  >
                    <td className="w-[110px] text-left px-1 py-2">
                      <span className="flex items-center gap-1.5">
                        <Checkbox size="sm" />
      ...
      {showViewTaskModal && (
        <div className="col-span-1 mt-[53px]">
          <ViewTaskModal task={viewTask} onClose={closeViewTaskModal} />
        </div>
      )}
    </div>
  );
