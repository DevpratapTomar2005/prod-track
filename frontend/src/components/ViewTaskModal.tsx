...
interface ViewTaskModalProps {
  ...
  getTaskTimer: (id: number) => TaskTimerRecord;
  patchTaskTimer: (id: number, patch: Partial<TaskTimerRecord>) => void;
...
const ViewTaskModal = ({
  ...
  return (
    <div className="p-4 w-full bg-white h-[calc(100vh-53px)] overflow-y-auto [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-thumb]:bg-cyan-100 [&::-webkit-scrollbar-track]:bg-gray-100/40">
      ...
      <div className="mt-8">
        <Timer
          value={Number(task.estDuration)}
          unit={task.estDurationUnit as "minutes" | "hours"}
