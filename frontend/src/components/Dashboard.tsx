      ...
      <div className="max-w-[1200px] mx-auto px-6 py-6 space-y-8">
        ...
        <section>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-[13px] font-inter font-semibold text-gray-700">
              Overall Matrices
            </h2>
          </div>
          <div className="grid grid-cols-3 gap-4 dashboard-overall-matricies">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm dashboard-overall-matricies-2">
              ...
              <CardSubtitle>
                Efficiency % (tasks completed ÷ planned) — last 4 weeks
              </CardSubtitle>
              <ResponsiveContainer width="100%" height={200}>
                <AreaChart
                  data={productivityData}
                  margin={{ top: 4, right: 4, bottom: 0, left: -35 }}
                >
                  <defs>
                  ...
                  />
                  <Tooltip
                    contentStyle={{ fontSize: 11, fontFamily: "Poppins" }}
                  />
                  <Area
                    type="monotone"
                    dataKey="efficiency"
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm dashboard-overall-matricies-3">
              ...
              <CardSubtitle>
                Cross-project task urgency — your morning priority view
              </CardSubtitle>
              ...
              <div className="flex gap-3 mb-3">
                {[
                  {
                    label: "Overdue",
                    value: tasksDueSummary.overdue,
                    color: "text-[#8b5cf6]",
                  },
                  {
                    label: "Due today",
                    value: tasksDueSummary.today,
                    color: "text-[#fb4848]",
                  },
                  {
                    label: "Due this week",
                    value: tasksDueSummary.week,
                    color: "text-[#60a5fa]",
                  },
                ].map(({ label, value, color }) => (
                  <div
                    key={label}
                    className="flex-1 bg-gray-50 border border-gray-100 rounded-lg px-2.5 py-2"
                  >
                    <p
                      className={`text-[18px] font-inter font-bold ${color} text-center`}
                    >
                      {value}
                    </p>
                    <p className="text-[9px] font-poppins text-gray-400 text-center w-full">
                      {label}
                    </p>
                  </div>
                ))}
              ...
              {/* By project label */}
              <p className="text-[9px] font-poppins text-gray-400 mb-1">
                By project
              </p>
              ...
              <ResponsiveContainer width="100%" height={100}>
                ...
                >
                  ...
                  />
                  <Tooltip
                    contentStyle={{ fontSize: 10, fontFamily: "Poppins" }}
                  />
                  <Bar
                    dataKey="overdue"
                    fill="#8b5cf6"
              ...
              <div className="flex gap-3 mt-1.5 justify-center">
                {[
                  ["#8b5cf6", "Overdue"],
                  ["#fb4848", "Due today"],
                  ["#60a5fa", "Due this week"],
                ].map(([color, label]) => (
                  <span
                    key={label}
                    className="flex items-center gap-1 text-[9px] font-poppins text-gray-500"
                  >
                    <span
        ...
        <section className="mt-15">
          ...
          <div className="grid grid-cols-4 gap-4 dashboard-task-matrices">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm col-span-1">
              ...
              <CardSubtitle>
                Sorted by time, showing {Math.min(5, totalTasks)} of{" "}
                {totalTasks}
              </CardSubtitle>
              <div className="flex gap-4 mb-3 justify-evenly">
                <div>
                  <p className="text-[18px] font-inter font-bold text-gray-800 text-center">
                    {totalTasks}
                  </p>
                ...
                <div>
                  <p className="text-[18px] font-inter font-bold text-blue-500 text-center">
                    {inProgressTasks}
                  </p>
                  <p className="text-[9px] font-poppins text-gray-400 text-center">
                    In progress
                ...
                <div>
                  <p className="text-[18px] font-inter font-bold text-emerald-500 text-center">
                    {doneTasks}
                  </p>
                  <p className="text-[9px] font-poppins text-gray-400 text-center">
                    Done
                ...
                {todaysTasks.slice(0, 5).map((t) => (
                  ...
                  >
                    <div className="min-w-0">
                      <p className="text-[10px] font-inter font-medium text-gray-700 truncate">
                        {t.title}
                      </p>
              ...
              <div className="flex items-center justify-center">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <p className="text-[22px] font-inter font-bold text-gray-800">
                      58%
                    </p>
                    <p className="text-[9px] font-poppins text-gray-400">
                      on time
                ...
                {completionRateData.map((d) => (
                  ...
                  >
                    <div className="flex items-center gap-1.5">
                      ...
                      />
                      <span className="text-[10px] font-poppins text-gray-600">
                        {d.name}
                      </span>
                    </div>
                    <span className="text-[10px] font-semibold text-gray-800 font-poppins">
                      {d.value}%
                    </span>
                  </div>
                ))}
                <p className="text-[9px] font-poppins text-gray-400 pt-1">
                  Based on 148 tasks total
                </p>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm col-span-1">
              ...
              <div className="grid grid-cols-3 gap-2 mb-6">
                <div className="text-center">
                  <p className="text-[16px] font-inter font-bold text-cyan-500">
                    0.7h
                  </p>
                  <p className="text-[9px] font-poppins text-gray-400">
                    Avg time
                ...
                <div className="text-center">
                  <p className="text-[16px] font-inter font-bold text-gray-700">
                    24
                  </p>
                  <p className="text-[9px] font-poppins text-gray-400">
                    Tasks included
                ...
                <div className="text-center">
                  <p className="text-[16px] font-inter font-bold text-violet-500">
                    70%
                  </p>
                  <p className="text-[9px] font-poppins text-gray-400">
                    vs limit
              ...
              <div className="space-y-2">
                {filteredCategories.map((c) => (
                  <div key={c.name} className="flex items-center gap-2">
                    <p className="text-[10px] font-poppins text-gray-600 w-20 shrink-0">
                      {c.name}
                    </p>
                    ...
                    <p className="text-[10px] font-poppins font-semibold text-gray-700 w-8 text-right">
                      {c.avg}h
                    </p>
                  </div>
                ))}
        ...
        <section className="mt-15">
          ...
          <div className="grid md:grid-cols-7 xl:grid-cols-4 gap-4 mb-4 first-proj-matrix-row">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm md:col-span-3 xl:col-span-2 first-proj-matrix-row-1">
              ...
              <div className="flex flex-wrap gap-x-3 gap-y-1 mt-4 w-fit mx-auto">
                {[
                  ["Project Alpha", "#06b6d4"],
                  ["Nova Quiz", "#8b5cf6"],
                  ["AI Chatbot", "#f59e0b"],
                  ["Fintech Dashboard", "#10b981"],
                ].map(([name, color]) => (
                  <span
                    key={name}
                    className="flex items-center gap-1 text-[9px] font-poppins text-gray-500"
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm md:col-span-2 xl:col-span-1 first-proj-matrix-row-2">
              ...
              <CardSubtitle>
                No update detected for more than 3 days
              </CardSubtitle>
              ...
              <div className="space-y-1.5">
                {stuckTasks.map((t, i) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-[10px] font-poppins font-semibold shrink-0 ml-2 ${t.days >= 5 ? "text-[#fb4848]" : "text-[#ffb940]"}`}
                    >
                      {t.days}d idle
                    </span>
                  </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm md:col-span-2 xl:col-span-1 first-proj-matrix-row-3">
              ...
              <CardSubtitle>
                Projects nearing estimated end date — sorted by urgency
              </CardSubtitle>
              <div className="flex gap-4 mb-3 justify-center">
                {[
                  ["Due Today", 1],
              ...
              <div className="space-y-2">
                {dueSoonProjects.map((p, i) => (
                  ...
                  >
                    <div>
                      <p className="text-[10px] font-inter font-medium text-gray-700">
                        {p.name}
                      </p>
                      <StatusBadge status={p.status} />
                    </div>
                    <span
                      className={`text-[10px] font-poppins font-semibold ${p.daysLeft <= 2 ? "text-[#fb4848]" : "text-gray-500"}`}
                    >
                      {p.daysLeft <= 2
          ...
          <div className="grid grid-cols-3 gap-4 secnd-proj-matrix-row">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm secnd-proj-matrix-row-1">
              ...
              <CardSubtitle>
                High hours for low progress signals a struggling project
              </CardSubtitle>
              <div className="flex gap-4 mb-4">
                ...
                <div>
                  <p className="text-[18px] font-inter font-bold text-[#ffb940] text-center">
                    AI Chatbot
                  </p>
                  <p className="text-[9px] font-poppins text-gray-400 text-center">
                    Most inefficient
              ...
              <div className="flex gap-3 mt-2 w-fit mx-auto">
                <span className="flex items-center gap-1 text-[9px] font-poppins text-gray-500">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm secnd-proj-matrix-row-2">
              ...
              <CardSubtitle>
                Share of projects completed on time, with overrun, or still
                pending
              </CardSubtitle>
              <div className="flex items-center justify-center">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <p className="text-[18px] font-inter font-bold text-gray-800">
                      5
                    </p>
                    <p className="text-[9px] font-poppins text-gray-400">
                      projects
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm secnd-proj-matrix-row-3">
              ...
              <CardSubtitle>
                Total overrun hours ranked — highlights which projects need
                immediate attention
              </CardSubtitle>
                ...
                {overrunProjects.map((p, i) => {
                  ...
                  return (
                    <div key={i} className="flex items-center gap-2">
                      <p className="text-[10px] font-poppins text-gray-600 w-28 shrink-0 truncate">
                        {p.name}
                      </p>
                      ...
                      <p className="text-[10px] font-poppins font-semibold text-gray-700 w-8 text-right shrink-0">
                        {p.hours}h
                      </p>
                    </div>
                  );
